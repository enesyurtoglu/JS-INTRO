...
students.includes('John', 1); // false searching the element after the index #1
...
students.lastIndexOf('Jane'); // 3 sondan bulmaya başlar ama index sıralaması baştan olur yani yine 3 çıkar sonuç

students.indexOf('Omar'); // 4
students.lastIndexOf('Omar'); // 5

students.indexOf('Heidi'); // -1 Meaning no Heide in the array 
students.lastIndexOf('Heidi'); // -1 Meaning no Heide in the array 
